...
A simple Chrome extension that automatically times your LeetCode problems, reminds you when to revise old questions, and gives you a personal dashboard to track topic goals.
...
- **Zero-click timer**: Opens automatically on any LeetCode problem. The second you submit and get **Accepted**, it stops the clock and saves your time.
- **Revision scheduler (Spaced Repetition)**: Automatically figures out when you should solve the problem again (1 day, 6 days, 15 days...) so you don't forget old patterns.
- **Personal struggle score**: Rates how hard a problem was *for you* based on your actual solve time and wrong attempts, instead of just LeetCode's Easy/Medium/Hard.
